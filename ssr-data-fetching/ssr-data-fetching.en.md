...
| Rendering without data (Suspense)           | ✔️ Impossible.                                                   | ✔️ Impossible.                                                                                              | ✔️ Impossible.                                                                       |
...
| Number of server-side renders (Suspense)    | ✔️ A single render.                                              | ✔️ A single render.                                                                                         | ✔️ A single render.                                                                  |
